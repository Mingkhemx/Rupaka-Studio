    ...
    <section id="hero" className="relative bg-page-bg overflow-hidden pt-[180px] pb-[80px] md:pt-[220px]">
      ...
      <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16 flex flex-col items-center text-center">
        ...
        <motion.div
          ...
          className="w-full max-w-[1280px] bg-white-card overflow-hidden shadow-[0_32px_64px_-16px_rgba(0,0,0,0.12)] relative z-10 rounded-[24px] md:rounded-[40px] aspect-[16/9] md:aspect-[21/9] flex items-center justify-center"
        >
          <img
