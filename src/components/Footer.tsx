...
export default function Footer() {
  const handleWhatsAppChat = () => {
    const waUrl = `https://wa.me/62856043235122?text=Halo%20Rupaka%20Studio%2C%20saya%20tertarik%20untuk%20berdiskusi%20mengenai%20desain%20untuk%20UMKM%20saya.`;
